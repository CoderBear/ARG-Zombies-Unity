...
{	 
	...
	deathSprite.setSize (Global.screenW * 0.4791 ,Global.screenH * 0.9062);
	deathSprite.position = Vector3(Global.screenW * 0.2708 ,-Global.screenH * 0.0468);
...
function OnGUI ()
{
    ...
    if(bLoading)
        {   
            if(Global.randomNumber <= 0.33)
                GUI.DrawTexture (Rect(0,0,Global.screenW,Global.screenH), texLoading1, ScaleMode.StretchToFill, true, 1);
            else if(Global.randomNumber > 0.33 && Global.randomNumber <= 0.66)
                GUI.DrawTexture (Rect(0,0,Global.screenW,Global.screenH), texLoading2, ScaleMode.StretchToFill, true, 1);
            else GUI.DrawTexture (Rect(0,0,Global.screenW,Global.screenH), texLoading3, ScaleMode.StretchToFill, true, 1);
	...
	if(bLooting)
		{	
			GUI.DrawTexture (Rect(Global.screenW * 0.2333, Global.screenH * 0.1781,Global.screenW * 0.25, Global.screenH * 0.64375), texLootB, ScaleMode.StretchToFill, true, 1);
			...
			GUI.Label(Rect(Global.screenW * 0.3125, Global.screenH * 0.3062,Global.screenW * 0.25, Global.screenH * 0.3125), "Loot", guiStyle);
			GUI.Label(Rect(Global.screenW * 0.4895, Global.screenH * 0.3062,Global.screenW * 0.4062, Global.screenH * 0.3125), sLootName, lootStyle);
			GUI.Label(Rect(Global.screenW * 0.3125, Global.screenH * 0.4062,Global.screenW * 0.625, Global.screenH * 0.3125), "$", guiStyle);
			GUI.Label(Rect(Global.screenW * 0.4375, Global.screenH * 0.4062,Global.screenW * 0.625, Global.screenH * 0.3125), "" + nLootGold, lootStyle);
			GUI.Label(Rect(Global.screenW * 0.3125, Global.screenH * 0.5125,Global.screenW * 0.625, Global.screenH * 0.3125), "XP", guiStyle);
			GUI.Label(Rect(Global.screenW * 0.4375, Global.screenH * 0.5125,Global.screenW * 0.625, Global.screenH * 0.3125), "" + nLootXP, lootStyle); 
			
			if(GUI.Button(Rect(Global.screenW * 0.4145, Global.screenH * 0.625,Global.screenW * 0.1729, Global.screenH * 0.1031), "Continue", styleOrangeBut))
				{
					bLooting = false;
					endFight();
				}
	...
	//GUI.DrawTexture(Rect(Global.screenW * 0.0104, Global.screenH * 0.009375,Global.screenW * 0.0041, Global.screenH * 0.0468), texHPc1, ScaleMode.StretchToFill, true, 1);
	...
	//GUI.DrawTexture(Rect(Global.screenW * 0.0145+((cPC.HP+0.0)/tempHP)*Global.screenW * 0.4166, Global.screenH * 0.009375, Global.screenW * 0.004166, Global.screenH * 0.0468), texHPc3, ScaleMode.StretchToFill, true, 1);
	GUI.Label(Rect(Global.screenW * 0.0104, Global.screenH * 0.0125,Global.screenW * 0.4375, Global.screenH * 0.0625),cPC.HP+"/" +tempHP, statsStyle);
	
	// Mana char
	//GUI.DrawTexture(Rect(Global.screenW * 0.0104, Global.screenH * 0.00416,Global.screenW * 0.4375, Global.screenH * 0.0406), texMana1, ScaleMode.StretchToFill, true, 1);
	GUI.DrawTexture(Rect(Global.screenW * 0.0166, Global.screenH * 0.0625, ((cPC.ENRG+0.0)/tempENRG)*Global.screenW * 0.2083, Global.screenH * 0.0406	), texMana2, ScaleMode.StretchToFill, true, 1);
	//GUI.DrawTexture(Rect(Global.screenW * 0.0166+((cPC.ENRG+0.0)/tempENRG)*Global.screenW * 0.2083, Global.screenH * 0.0625,Global.screenW * 0.00625, Global.screenH * 0.0406), texMana3, ScaleMode.StretchToFill, true, 1);
	GUI.Label(Rect(Global.screenW * 0.0104, Global.screenH * 0.0625,Global.screenW * 0.2291, Global.screenH * 0.0625),cPC.ENRG+"/"+tempENRG, statsStyle);
	
	// HP mob 
	
	//GUI.DrawTexture(Rect(Global.screenW * 0.9854, Global.screenH * 0.009375,Global.screenW * 0.2291, Global.screenH * 0.0468), texHPm3, ScaleMode.StretchToFill, true, 1);
	GUI.DrawTexture(Rect(Global.screenW * 0.9854-((eChar.HP+0.0)/enemyPCScript.HP)*Global.screenW * 0.4166, Global.screenH * 0.009375, ((eChar.HP+0.0)/enemyPCScript.HP)*Global.screenW * 0.4166, Global.screenH * 0.0468), texHPm2, 										ScaleMode.StretchToFill, true, 1);
	//GUI.DrawTexture(Rect(Global.screenW * 0.98125-((eChar.HP+0.0)/enemyPCScript.HP)*Global.screenW * 0.4166, Global.screenH * 0.009375,Global.screenW * 0.00416, Global.screenH * 0.0468), texHPm1, ScaleMode.StretchToFill, true, 1);
	GUI.Label(Rect(Global.screenW * 0.5645, Global.screenH * 0.0125,Global.screenW * 0.4375, Global.screenH * 0.0625),eChar.HP+"/"+enemyPCScript.HP, statsStyle);
	
	// Mana mob
	
	//GUI.DrawTexture(Rect(Global.screenW * 0.9833, Global.screenH * 0.0625,Global.screenW * 0.00625, Global.screenH * 0.0406), texMana3, ScaleMode.StretchToFill, true, 1);
	GUI.DrawTexture(Rect(Global.screenW * 0.9833-((eChar.ENRG+0.0)/enemyPCScript.ENRG)*Global.screenW * 0.2083, Global.screenH * 0.0625, ((eChar.ENRG+0.0)/enemyPCScript.ENRG)*Global.screenW * 0.2083, Global.screenH * 0.0406), texMana2, 								ScaleMode.StretchToFill, true, 1);
	//GUI.DrawTexture(Rect(Global.screenW * 0.977-((eChar.ENRG+0.0)/enemyPCScript.ENRG)*Global.screenW * 0.2083, Global.screenH * 0.0625,Global.screenW * 0.009375, Global.screenH * 0.0406), texMana1, ScaleMode.StretchToFill, true, 1);
	GUI.Label(Rect(Global.screenW * 0.775, Global.screenH * 0.0625,Global.screenW * 0.2291, Global.screenH * 0.0625),eChar.ENRG+"/"+enemyPCScript.ENRG, statsStyle);
	
	// Interface
	//GUI.DrawTexture(Rect(215, 5, 51, 39), texTV, ScaleMode.StretchToFill, true, 1);
	textLabelStyle.alignment = TextAnchor.UpperRight;
	GUI.Label(Rect(Global.screenW * 0.8229, Global.screenH * 0.1093,Global.screenW * 0.1666, Global.screenH * 0.075), enemyPCScript.Nick, textLabelStyle);
	textLabelStyle.alignment = TextAnchor.UpperLeft;
	GUI.Label(Rect(Global.screenW * 0.0104, Global.screenH * 0.1093,Global.screenW * 0.1666, Global.screenH * 0.075), Global.myChar.Nick, textLabelStyle);
	...
	if(!Inventory.bInventory)
	{
		...
		if(bAttack && Queue.length == 0 && cPC.HP > 0 && eChar.HP > 0)
		{
			...
			if(GUI.Button(Rect(Global.screenW * 0.0875, Global.screenH * 0.2343,Global.screenW * 0.1729, Global.screenH * 0.1156), "", btnStyle) && (Queue.length == 0))
				{				
					bAttack = false;
					if(cPC.WepType != 3)
						{
			...
			if(playerHasBrace > -1)
				{
					...
					if(GUI.Button(Rect(Global.screenW * 0.0875, Global.screenH * 0.3906,Global.screenW * 0.1729, Global.screenH * 0.1156), "", btnStyle) && (Queue.length == 0))
						{
			...
			if(playerHasConcentrate > -1)
			{
				...
				if(GUI.Button(Rect(Global.screenW * 0.0875, Global.screenH * 0.5468,Global.screenW * 0.1729, Global.screenH * 0.1156), "", btnStyle) && (Queue.length == 0))
					{
			...
			if(playerHasRecover > -1)
				{
					...
					if(GUI.Button(Rect(Global.screenW * 0.0875, Global.screenH * 0.7031,Global.screenW * 0.1729, Global.screenH * 0.1156), "", btnStyle) && (Queue.length == 0))
						{
		...
		if(doSpecial && Queue.length == 0 && cPC.HP > 0 && eChar.HP > 0)
			{	
				...
				for(var i = 0; i < playerSpecialAttacks.length; i++ )
					if( GUI.Button( Rect( Global.screenW * 0.2916, Global.screenH * 0.1875 + gridHSpecialAttacks/320 * Global.screenH * 0.00343 * i, Global.screenW * 0.25, gridHSpecialAttacks/320 ), 
...
*/
	...
	*/
	...
	textLabelStyle.alignment = TextAnchor.UpperLeft;
	GUI.Label(Rect(Global.screenW * 0.0208, Global.screenH * 0.1875,Global.screenW * 0.0416, Global.screenH * 0.0625), "" + Global.myChar.LVL, textLabelStyle);
	textLabelStyle.alignment = TextAnchor.UpperRight;
	GUI.Label(Rect(Global.screenW * 0.9375, Global.screenH * 0.1875,Global.screenW * 0.0416, Global.screenH * 0.0625), "" + eChar.LVL, textLabelStyle);
}
	...
	switch(position)
		{
			...
			var	theStyle = guiStyle3;
				...
				printText(Rect(Global.screenW * 0.3958, Global.screenH * 0.3125,Global.screenW * 0.2083, Global.screenH * 0.3125), theText);
				break;
			case POS_PC:
				theStyle = guiStyle2;
				printText(Rect(Global.screenW * 0.1666, Global.screenH * 0.3125,Global.screenW * 0.1666, Global.screenH * 0.3125), theText);
				break;
			case POS_MOB1:
				theStyle = guiStyle2;
				printText(Rect(Global.screenW * 0.8333, Global.screenH * 0.3125,Global.screenW * 0.1666, Global.screenH * 0.3125), theText);
				break;
		}
	switch(theText)
		{
...
{
	printText(Rect(Global.screenW * 0.4166, Global.screenH * 0.3125,Global.screenW * 0.2083, Global.screenH * 0.3125), theText);
}
...
function DoLootAlert (windowID : int) 
{
	...
	GUI.Label(Rect(Global.screenW * 0.04166, Global.screenH * 0.09375,Global.screenW * 0.3958, Global.screenH * 0.125),"Not enough free slots.\nPlease remove some items.");
