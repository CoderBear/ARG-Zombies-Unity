	...
	{  
      //  color = Color.white;
       //yield FadeOutAfterTime(3);
		...
		x = new Vector2(-Global.screenW * 0.2083, -Global.screenH * 0.3125);
        ...
        swipeToContinue.text = "Tap to continue";
...
{	
    ...
    if ( i == Subtitles.Length + 1 )
     {  
     	 ...
     	 if(GUI.Button(Rect(Global.screenW * 0.58333, Global.screenH * 0.4625, Global.screenW * 0.2, Global.screenH * 0.23125), "", styles[0])) 
     	 {
    	 ...
    	 if(GUI.Button(Rect(Global.screenW * 0.1333, Global.screenH * 0.3125, Global.screenW * 0.2666, Global.screenH * 0.50), "", styles[1])) 
    	 {
     	 ...
     	 if(GUI.Button(Rect(Global.screenW * 0.3333, Global.screenH * 0.6406, Global.screenW * 0.4083, Global.screenH * 0.2), "", styles[2])) 
     	 {
     	 	styles[0].normal.background = Resources.Load("Menus/CutScene/GUIItems/bibi_gun_u");
     	 	styles[1].normal.background = Resources.Load("Menus/CutScene/GUIItems/gloves_facemask_u" );
...
function Update () {
	...
	if (Input.GetMouseButton(0) && !next) {
		...
		x = new Vector2( -Global.screenW * 0.2083, -Global.screenH * 0.312 );
	}
  ...
  //  obj1.transform.position.x = obj1.transform.position.x+poz1.x;
	  ...
	  if ( obj2.transform.position.y > 0/* && Input.mousePosition.x<70*/ ) 
	  {
 ...
 if (fadeOut)
	  ...
	  { 
	    ...
	    swipeToContinue.material.color.a+=fadeAmount-0.15;
	    		...
	    		fadeOut = false;
	    		subtitle.material.color.a = 1;
	   		    swipeToContinue.material.color.a = 0.5;
	   		 }  
