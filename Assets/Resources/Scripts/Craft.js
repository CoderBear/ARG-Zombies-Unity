...
function UpdateItems()
{
	...
	var vector : String = "";
	//var url : String = "http://www.b-0.info/mmo_iphone/update_item.php";
	var url : String = Global.server + "/mmo_iphone/update_item.php";
	...
	print( "" + itemToCraft + "  " + allItems[itemToCraft].name);
...
function OnGUI()
{
	...
	GUI.DrawTexture(Rect(115, 45, 345, 270), texBack);
	...
	if(GUI.Button(Rect(205, 50, 35, 18) ,"", styleDiff1))
	    {
	        changedLvl1 = true;
	        changedLvl2 = false;
	        changedLvl3 = false;
    ...
    if(GUI.Button(Rect(240, 50, 35, 18),"",styleDiff2))
	    {
	        changedLvl2 = true;
	        changedLvl1 = false;
	        changedLvl3 = false;
    ...
    if(GUI.Button(Rect(275, 50, 35, 18),"",styleDiff3))
	    {
	        changedLvl3 = true;
	        changedLvl2 = false;
	        changedLvl1 = false;
    ...
    if(GUI.Button(Rect(310, 50, 35, 18),"",styleDiff4))
	    {
	        changedLvl4 = true;
	        changedLvl2 = false;
	        changedLvl3 = false;
    ...
    if(GUI.Button(Rect(345, 50, 35, 18),"",styleDiff5))
	    {
	        changedLvl5 = true;
	        changedLvl2 = false;
	        changedLvl3 = false;
    ...
    if(GUI.Button(Rect(380, 50, 35, 18),"",styleDiff6))
	    {
	        changedLvl6 = true;
	        changedLvl2 = false;
	        changedLvl3 = false;
	...
	if(nCraftPos!=-1)
		if(GUI.Button(Rect(370, 283, 69, 30), "", styleCraftBut))
			{ 
	...
	if(GUI.Button(Rect(278, 283, 69, 30), "", styleBackBut))
		{
			bCraft = false;
